# -*- coding: utf-8 -*-
"""
Created on Wed Jun 27 14:58:53 2018
...
# W_conv1 -> [5, 5, 1, 16]
# output  -> [batch, 28, 28, 16]
h_pool1 = max_pool_2x2(h_conv1)
# h_conv1 -> [batch, 28, 28, 16]
# output  -> [batch, 14, 14, 16]
...
h_pool2(batch, 7, 7, 32) -> h_fc1(1, 128)
"""
...
accuracy_list = []
for i in range(10): #分批对测试集进行测试   
     batch = mnist.test.next_batch(100) #batch大小设置为1000
...
print("The whole test accuracy is " + str(np.array(accuracy_list).mean()))
